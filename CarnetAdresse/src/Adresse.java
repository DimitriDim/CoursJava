...
public class Adresse {
	...
	public static boolean ChercheCodePostal(String cp) { // static car c'est une methode de classe qui n'utilise aucun
															// objet
		...
		try {
			...
			String lignebr1;
			StringTokenizer s;
			br1 = new BufferedReader(new FileReader("fichier.txt"));
